...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('c_FK', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventory.contains')),
                ('o_FK', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventory.orders')),
            ],
        ),
        migrations.CreateModel(
            name='Manufactures',
        ...
        migrations.CreateModel(
            name='ManufacturePart',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('c_FK', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventory.contains')),
                ('m_FK', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inventory.manufactures')),
            ],
        ),
        migrations.CreateModel(
            name='MadeOf',
