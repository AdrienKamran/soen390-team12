...
urlpatterns = [
    ...
    path('get-sell-vendor/', views.returnSellingVendor, name='return-sell-vendor'), # ajax endpoint that returns a specific list of vendors
    path('get-all-vendors/', views.returnAllVendor, name='get-all-vendors'), # ajax endpoint that returns a list of all vendors
    ...
    path('download-order-history-csv/', views.download_inventory_history, name='download-inventory-history'), # download the orders as a csv file
]