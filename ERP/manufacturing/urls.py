...
urlpatterns = [
    ...
    path('download-manufacturing-history-csv/', views.download_manufacturing_history, name='download-manufacturing-history'), #url endpoint for downloading the manufacturing history
]