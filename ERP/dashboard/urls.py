...
urlpatterns = [
    ...
    path('get-user-groups/', views.getUserGroups, name='get-user-groups'), # An endpoint that returns the users' group
    path('update-user-groups/', views.updateUserGroups, name="update-user-groups"), # An endpoint that updates the users' group
]
